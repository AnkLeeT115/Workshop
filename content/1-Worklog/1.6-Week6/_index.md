...
- Understood application packaging using **Docker**:
  - Built Docker Images.
  - Managed Images for deployment.
  - Learned the role of Containers in Cloud application development.

- Practiced deploying Container applications on AWS:
  - Amazon ECS.
  - Amazon EKS.
  - AWS Fargate.
...
- Learned how to build scalable Microservices systems:
  ...
  - Scale individual services based on traffic demand.
  - Manage Cloud resources efficiently.

- Built a CI/CD workflow using:
  - AWS CodePipeline.
  - GitHub.
...
- Learned Container monitoring and security practices:
